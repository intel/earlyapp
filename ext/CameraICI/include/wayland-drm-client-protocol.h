		...
		int32_t stride2)
{
	...
	id = wl_proxy_marshal_constructor((struct wl_proxy *) wl_drm,
			 WL_DRM_CREATE_PLANAR_BUFFER, &wl_buffer_interface,
			 NULL, name,  width, height, format, offset0, stride0,
			 offset1, stride1, offset2, stride2);

	return (struct wl_buffer *) id;
}

static inline struct wl_buffer *
wl_drm_create_prime_buffer(struct wl_drm *wl_drm, int32_t name, int32_t width,
		...
		int32_t offset1, int32_t stride1, int32_t offset2, int32_t stride2)
{
	...
	id = wl_proxy_marshal_constructor((struct wl_proxy *) wl_drm,
			 ...
			 name, width, height, format, offset0, stride0,
			 offset1, stride1, offset2, stride2);
